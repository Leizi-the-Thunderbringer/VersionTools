...
public:
    ...
    std::vector<std::string> buildArgVector(const std::string& command,
                                           const std::vector<std::string>& args) {
...
SystemCommandResult SystemCommand::execute(const std::string& command,
                                          const std::vector<std::string>& args,
...
#ifdef _WIN32
SystemCommandResult SystemCommand::executeWindows(const std::string& command,
                                                  const std::vector<std::string>& args,
                                                  const std::string& workingDirectory) {
...
SystemCommandResult SystemCommand::executeUnix(const std::string& command,
                                               const std::vector<std::string>& args,
                                               const std::string& workingDirectory) {
...
SystemCommandResult SystemCommand::executeWithCallback(const std::string& command,
                                                       const std::vector<std::string>& args,
...
void SystemCommand::executeAsync(const std::string& command,
                                const std::vector<std::string>& args,
